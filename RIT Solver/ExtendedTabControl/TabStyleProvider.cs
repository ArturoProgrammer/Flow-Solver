...
namespace FlowControls
{
    ...
    public abstract class TabStyleProvider : Component
    {
        ...
        protected TabStyleProvider(flCustomTabControl tabControl){
        ...
        public static TabStyleProvider CreateProvider(flCustomTabControl tabControl){
        ...
        protected flCustomTabControl _TabControl;
        ...
        protected virtual Brush GetTabBackgroundBrush(int index){
            ...
            if (this._TabControl.SelectedIndex == index) {
                dark = System.Drawing.SystemColors.ControlLight;
                light = System.Drawing.SystemColors.Window;
            ...
            set {
                ...
                if (this._ShowTabCloser){
                    if (value.X + (int)(this._Radius/2) < -6){
                        ((TabControl)this._TabControl).Padding = new System.Drawing.Point(0, (int)value.Y);
                    } else {
                        ((TabControl)this._TabControl).Padding = new System.Drawing.Point((int)value.X + (int)(this._Radius/2) + 6, (int)value.Y);
                    }
                } else {
                    if (value.X + (int)(this._Radius/2) < 1){
                        ((TabControl)this._TabControl).Padding = new System.Drawing.Point(0, (int)value.Y);
                    } else {
                        ((TabControl)this._TabControl).Padding = new System.Drawing.Point((int)value.X + (int)(this._Radius/2) -1, (int)value.Y);
                    }
                }
            }
        }
        ...
        public Color BorderColorHot
        {
            ...
            set {
                if (value.Equals(System.Drawing.SystemColors.ControlDark)){
        ...
        public Color TextColor
        {
            ...
            set {
                if (value.Equals(System.Drawing.SystemColors.ControlText)){
            ...
            if (this._FocusTrack && this._TabControl.Focused && index == this._TabControl.SelectedIndex) {
                ...
                switch (this._TabControl.Alignment) {
                    case TabAlignment.Top:
                        ...
                        focusBrush = new LinearGradientBrush(focusRect,this._FocusColor, System.Drawing.SystemColors.Window, LinearGradientMode.Vertical);
                        break;
                    case TabAlignment.Bottom:
                        focusRect = new Rectangle((int)pathRect.X, (int)pathRect.Bottom - 4, (int)pathRect.Width, 4);
                        focusBrush = new LinearGradientBrush(focusRect, System.Drawing.SystemColors.ControlLight, this._FocusColor, LinearGradientMode.Vertical);
                        break;
                    case TabAlignment.Left:
                        focusRect = new Rectangle((int)pathRect.X, (int)pathRect.Y, 4, (int)pathRect.Height);
                        focusBrush = new LinearGradientBrush(focusRect, this._FocusColor, System.Drawing.SystemColors.ControlLight, LinearGradientMode.Horizontal);
                        break;
                    case TabAlignment.Right:
                        focusRect = new Rectangle((int)pathRect.Right - 4, (int)pathRect.Y, 4, (int)pathRect.Height);
                        focusBrush = new LinearGradientBrush(focusRect, System.Drawing.SystemColors.ControlLight, this._FocusColor, LinearGradientMode.Horizontal);
                        break;
                }
