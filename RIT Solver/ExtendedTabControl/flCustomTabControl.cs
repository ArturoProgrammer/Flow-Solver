...
namespace FlowControls
{
	...
	public class flCustomTabControl : TabControl
	{
		
		#region	Construction

		public flCustomTabControl(){
		...
		private System.Drawing.Point _dragStartPosition = System.Drawing.Point.Empty;
		...
		[Category("Appearance"), DefaultValue(typeof(TabStyle), "Angled"), RefreshProperties(RefreshProperties.All)]
		...
		#region Drag 'n' Drop
 		...
 		protected override void OnMouseDown(MouseEventArgs e){
  			base.OnMouseDown(e);
  			if (this.AllowDrop){
  			    this._dragStartPosition = new System.Drawing.Point(e.X, e.Y);
  			}
  		}
  		...
  		protected override void OnMouseUp(MouseEventArgs e){
  			base.OnMouseUp(e);
  			if (this.AllowDrop){
  			    this._dragStartPosition = System.Drawing.Point.Empty;
  			}
  		}
  		...
  		private void StartDragDrop(){
  			if (!this._dragStartPosition.IsEmpty){
  			    ...
  			    if (dragTab != null){
  				    ...
  				    Rectangle dragTestRect = new Rectangle(this._dragStartPosition, System.Drawing.Size.Empty);
